...
namespace TbMis.ExportSubscriptionPlan.Entities
{
    ...
    [ConnectionKey("Default"), Module("ExportSubscriptionPlan"), TableName("[dbo].[StudentWholeData]")]
    [DisplayName("Student Whole Data"), InstanceName("Student Whole Data")]
    [ReadPermission("Administration")]
    [ModifyPermission("Administration")]
    public sealed class StudentWholeDataRow : Row, IIdRow, INameRow
    {

        [DisplayName("申报编号"), Column("DeclarationID"), Identity, QuickSearch,ForeignKey("[dbo].[StudentDeclaration_Bookseller]", "DeclarationID"), LeftJoin("jStudentDeclaration_Bookseller")]
        public Int32? DeclarationId
        {
            get { return Fields.DeclarationId[this]; }
            set { Fields.DeclarationId[this] = value; }
        }
        [DisplayName("书商编号"), Expression("jStudentDeclaration_Bookseller.[BooksellerID]"), ForeignKey("[dbo].[Bookseller]", "BooksellerID"), LeftJoin("jBookseller")]
        ...
        [DisplayName("学院名称"), Size(50), NotNull, QuickSearch]
        ...
        [DisplayName("班级名称"), Size(50), NotNull, QuickSearch]
        ...
        [DisplayName("课程IDCourse Num Course Id"), Expression("jCourseNum.[CourseID]")]
