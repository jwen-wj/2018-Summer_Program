...
namespace TbMis.ExportSubscriptionPlan.Columns
{
    ...
    [ColumnsScript("ExportSubscriptionPlan.StudentDeclarationBookseller")]
    ...
    public class StudentDeclarationBooksellerColumns
    {
        ...
        public String TextbookName { set; get; }
        ...
        [LookupEditor(typeof(Modules.ExportSubscriptionPlan.Lookups.StudentSubscriptionStatusLookup)), QuickFilter(CssClass = "hidden-xs")]
