...
namespace TbMis.ImportDeclarationPlan.Entities
{
    ...
    [ConnectionKey("Default"), Module("ImportDeclarationPlan"), TableName("[dbo].[StudentWholeData]")]
    ...
    public sealed class StudentWholeDataRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("教材名称"), ForeignKey("[dbo].[Textbook]", "TextbookNum2"), LeftJoin("jTextbookNum2"), TextualField("TextbookNum2TextbookId")]
