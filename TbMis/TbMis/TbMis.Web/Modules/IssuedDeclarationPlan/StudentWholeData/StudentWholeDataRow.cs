...
namespace TbMis.IssuedDeclarationPlan.Entities
{
    ...
    [ConnectionKey("Default"), Module("IssuedDeclarationPlan"), TableName("[dbo].[StudentWholeData]")]
    ...
    public sealed class StudentWholeDataRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Class Name"), Size(50), NotNull]
        ...
        [DisplayName("Class Size"), Size(50), NotNull]
