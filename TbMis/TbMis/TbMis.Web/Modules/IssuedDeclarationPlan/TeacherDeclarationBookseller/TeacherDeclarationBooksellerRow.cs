...
namespace TbMis.IssuedDeclarationPlan.Entities
{
    ...
    [ConnectionKey("Default"), Module("IssuedDeclarationPlan"), TableName("[dbo].[TeacherDeclaration_Bookseller]")]
    ...
    public sealed class TeacherDeclarationBooksellerRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("申报编号"), Column("DeclarationID"), PrimaryKey, NotNull ,ForeignKey("[dbo].[TeacherWholeData]", "DeclarationID"), LeftJoin("jDeclaration"), TextualField("DeclarationTermCode")]
        [LookupEditor(typeof(Teacher.Lookups.DeclarationIdLookup), CascadeFrom = "SchoolName", AutoComplete = true)]
        ...
        [DisplayName("开课学院"), Expression("jDeclaration.[SchoolName]"), NotNull]
        [LookupEditor(typeof(Teacher.Lookups.SchoolNameLookup), AutoComplete = true)]
