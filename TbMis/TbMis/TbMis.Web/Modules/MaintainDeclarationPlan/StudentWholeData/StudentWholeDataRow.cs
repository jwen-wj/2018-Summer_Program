...
namespace TbMis.MaintainDeclarationPlan.Entities
{
    ...
    [ConnectionKey("Default"), Module("MaintainDeclarationPlan"), TableName("[dbo].[StudentWholeData]")]
    [DisplayName("学生用书"), InstanceName("Student Whole Data")]
    [ReadPermission("Administration")]
    [ModifyPermission("Administration")]
    public sealed class StudentWholeDataRow : Row, IIdRow, INameRow
    {

        [DisplayName("申报编号"), Column("DeclarationID"), Identity]
        ...
        [DisplayName("学年编号"), Size(20), NotNull, QuickSearch]
        ...
        [DisplayName("学生学院名称"), Size(50), NotNull, LookupEditor(typeof(Modules.MaintainDeclarationPlan.Lookups.StudentSchoolNameLookup), AutoComplete = true)]
        ...
        [DisplayName("系教研室名称"), Size(50), NotNull, LookupEditor(typeof(Modules.MaintainDeclarationPlan.Lookups.StudentDepartmentNameLookup), CascadeFrom = "SchoolName", AutoComplete = true)]
        ...
        [DisplayName("教材编号"), ForeignKey("[dbo].[Textbook]", "TextbookNum2"), LeftJoin("jTextbookNum2"), TextualField("TextbookNum2TextbookId")]
        ...
        [DisplayName("班级名称"), Size(50), NotNull]
        ...
        [DisplayName("班级人数"), Size(50), NotNull]
        public String ClassSize
        {
            get { return Fields.ClassSize[this]; }
            set { Fields.ClassSize[this] = value; }
        }
        ...
        [DisplayName("译者"), Expression("jTextbookNum2.[Translator]")]
        ...
        [DisplayName("简介"), Expression("jTextbookNum2.[Summary]")]
        ...
        [DisplayName("目录"), Expression("jTextbookNum2.[Catalog]")]
