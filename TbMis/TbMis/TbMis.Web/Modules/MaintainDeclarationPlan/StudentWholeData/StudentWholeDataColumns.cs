...
namespace TbMis.MaintainDeclarationPlan.Columns
{
    ...
    [ColumnsScript("MaintainDeclarationPlan.StudentWholeData")]
    ...
    public class StudentWholeDataColumns
    {
        ...
        [LookupEditor(typeof(Modules.MaintainDeclarationPlan.Lookups.StudentSchoolNameLookup)), QuickFilter(CssClass = "hidden-xs")]
        public String SchoolName { get; set; }       
        [LookupEditor(typeof(Modules.MaintainDeclarationPlan.Lookups.StudentDepartmentNameLookup))]
