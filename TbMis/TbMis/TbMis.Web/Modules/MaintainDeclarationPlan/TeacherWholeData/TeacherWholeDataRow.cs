...
namespace TbMis.MaintainDeclarationPlan.Entities
{
    ...
    [ConnectionKey("Default"), Module("MaintainDeclarationPlan"), TableName("[dbo].[TeacherWholeData]")]
    [DisplayName("教师用书"), InstanceName("Teacher Whole Data")]
    ...
    public sealed class TeacherWholeDataRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("开课学院名称"), Size(50), NotNull, LookupEditor(typeof(Modules.MaintainDeclarationPlan.Lookups.TeacherSchoolNameLookup), AutoComplete = true)]
        ...
        [DisplayName("系教研室名称"), Size(50), NotNull, LookupEditor(typeof(Modules.MaintainDeclarationPlan.Lookups.TeacherDepartmentNameLookup), CascadeFrom = "SchoolName", AutoComplete = true)]
