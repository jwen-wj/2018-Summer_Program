...
namespace TbMis.MaintainDeclarationPlan.Entities
{
    ...
    [ConnectionKey("Default"), Module("MaintainDeclarationPlan"), TableName("[dbo].[Textbook]")]
    [DisplayName("Textbook Message"), InstanceName("Textbook Message")]
    [ReadPermission("Administration")]
    [ModifyPermission("Administration")]
    public sealed class TextbookMessageRow : Row, IIdRow, INameRow
    {
