...
namespace TbMis.FeedbackSubscriptionPlan.Entities
{
    ...
    [ConnectionKey("Default"), Module("FeedbackSubscriptionPlan"), TableName("[dbo].[StudentDeclaration_Bookseller]")]
    [DisplayName("学生用书"), InstanceName("Student Declaration Bookseller")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class StudentDeclarationBooksellerRow : Row, IIdRow, INameRow
    {

        [DisplayName("申报编号"), Column("DeclarationID"), PrimaryKey, ForeignKey("[dbo].[StudentWholeData]", "DeclarationID"), LeftJoin("jDeclaration"), TextualField("DeclarationTermCode")]
        [ReadOnly(true)]
        ...
        [DisplayName("学生学院"), Expression("jDeclaration.[SchoolName]")]
        [ReadOnly(true)]
